...
| Codex | `plugins` | `supported-native`: `plugins/<name>` | `supported-native`: `~/.codex/plugins/<name>` | Semantic Codex plugin directories. |
...
| GitHub Copilot CLI | `plugins` | `supported-native`: `.github/plugins/<name>` | `supported-native`: `~/.copilot/plugins/<name>` | Semantic Copilot plugin directories. |
...
| Hermes | `plugins` | `unsupported` | `supported-native`: `~/.hermes/plugins/<name>` | Semantic Hermes plugin directories. |
